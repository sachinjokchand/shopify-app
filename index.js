...
conn.query(
'CREATE TABLE product_data(id SERIAL PRIMARY KEY, shop_name VARCHAR(255) not null, customer_id VARCHAR(255), product_id VARCHAR(255) not null, product_title VARCHAR(255) not null, product_src VARCHAR(255) not null, product_price VARCHAR(255) not null, product_url VARCHAR(255) not null),  product_url VARCHAR(255) not null, product_time VARCHAR(255) not null)');
             ...
             if (results.rows.length>0) 
                {
                   ...
                   let sql_pro = "SELECT * FROM product_data WHERE shop_name='"+shop+"'";
